...
class DefaultTrainer(SimpleTrainer):
    ...
    def __init__(self, cfg):
        ...
        # * 定义深度学习四件套：model，optimizer，data_loader，lr_scheduler
        model = self.build_model(cfg)  # 定义模型
    ...
    def build_hooks(self):
        ...
        """
        cfg = self.cfg.clone()
        cfg.defrost() # Make this CfgNode and all of its children mutable. 冻结超参数，防止修改
        ...
        # This is not always the best: if checkpointing has a different frequency,W
    ...
    def build_writers(self):
        ...
        return [
            ...
            CommonMetricPrinter(self.max_iter),
            JSONWriter(os.path.join(self.cfg.OUTPUT_DIR, "metrics.json")),
            TensorboardXWriter(self.cfg.OUTPUT_DIR),  # 向tensorboard中写入数据
        ]
