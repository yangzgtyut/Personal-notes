...
# The version number, to upgrade from old configs to new ones if any changes happen. It's recommended to keep a VERSION in your config file.
_C.VERSION = 2  # 版本号
...
# * 默认使用"ROIAlignV2"，Faster R-CNN也是
...
# 17 is the number of keypoints in COCO.
